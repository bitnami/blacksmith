...
class FileSystemTracker {
  ...
  commit(msg) {
    ...
    if (res.code !== 0) {
      // The 'no changes added to commit' output is shown when a sub-folder includes a .git repository
      // It is not uncommon for web application projects to recommend that approach, i.e. to simplify upgrades
